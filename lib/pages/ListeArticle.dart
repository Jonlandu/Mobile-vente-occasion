...
void main() async {
  runApp(const ListeArticle());
}

class ListeArticle extends StatelessWidget {
  const ListeArticle({Key? key}) : super(key: key);
...
class AccordionPage extends StatelessWidget //__
  ...
  build(context) => Scaffold(
    ...
    appBar: AppBar(
      title: const Text('Listes Articles'),backgroundColor: Colors.white38,
    ),
    body: Accordion(
      maxOpenSections: 2,
      ...
      children: [
        AccordionSection(
          ...
          header: Text('Pantalons', style: _headerStyle),
          content: Text('user1', style: _contentStyle),
        ...
        AccordionSection(
          ...
          header: Text('Chemises', style: _headerStyle),
          ...
          content: Accordion(
            ...
            children: [
              AccordionSection(
                ...
                headerBackgroundColorOpened: Colors.black54,
                header: Text('Exaucé', style: _headerStyle),
        ...
        AccordionSection(
          ...
          header: Text('Chaussures', style: _headerStyle),
          content: DataTable(
            sortAscending: true,
            sortColumnIndex: 1,
            dataRowHeight: 40,
            ...
            columns: [
              DataColumn(
                  label: Text('User7', style: _contentStyleHeader),
                  numeric: true),
              DataColumn(
                  label: Text('user8', style: _contentStyleHeader)),
              DataColumn(
                  label: Text('user4', style: _contentStyleHeader),
                  numeric: true),
            ],
            rows: [
              DataRow(
        ...
        AccordionSection(
          ...
          header: Text('Jupes', style: _headerStyle),
          content: Wrap(
        ...
        AccordionSection(
          ...
          header: Text('talons', style: _headerStyle),
        ...
        AccordionSection(
          ...
          header: Text('Fers', style: _headerStyle),
          content:
        ...
        AccordionSection(
          ...
          header: Text('Sacs', style: _headerStyle),
          content:
        ...
        AccordionSection(
          ...
          header: Text('Chaises', style: _headerStyle),
          content:
